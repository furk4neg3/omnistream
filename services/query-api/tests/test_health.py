...
def configure_status_test_app(monkeypatch, tmp_path, processing_file, producer_file):
...
def test_status_endpoint_with_dependency_metrics_files(monkeypatch, tmp_path):
